...
public:
    ...
    {
        return getFirstName() == other.getFirstName() && getLastName() == other.getLastName() && getInitials() == other.getInitials();
    }
    bool operator!=(const Person& other) const
    {
        return !(*this == other);
    ...
    bool operator<(const Person& other) const
    {
        return (getFirstName() < other.getFirstName()) ||
            (getFirstName() == other.getFirstName() && getLastName() < other.getLastName()) ||
            (getFirstName() == other.getFirstName() && getLastName() == other.getLastName() && getInitials() < other.getInitials());
    }
    bool operator>(const Person& other) const
    {
        return other < *this;
